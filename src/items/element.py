...
def to_item(category: str, data: dict) -> Element:
    ...
    property_parser = {
        ...
        "effets évolutifs": Effet.from_multiple,
        "recette": Recette.from_dict,
        "bonus de la panoplie": bonus_pano_from_list,
        "caractéristiques": lambda value: value,
        "résistances": lambda value: value,
        "butins": lambda value: value,
        "butins conditionnés": lambda value: value,
        "bonus": lambda value: value,
